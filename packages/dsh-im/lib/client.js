window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var BUILTIN_TABS = [{ id: "im-bridge", order: 0, zh: "IM Bridge", en: "IM Bridge" }];
    ...
    var IM_UI = {
      en: {
        ...
        imessageHint: "macOS only. Requires imsg, Full Disk Access, and Automation access to Messages.",
        imessageConnect: "Connect", imessageDisconnect: "Disconnect",
      },
      zh: {
        ...
        imessageHint: "仅支持 macOS。需要安装 imsg，并授予终端完全磁盘访问权限和 Messages 自动化权限。",
        imessageConnect: "连接", imessageDisconnect: "断开",
      },
    };
    function imT(key) {
    ...
    function ImSettingsSection() {
      ...
      var imessage = status && status.imessage;
      ...
      var imessageColor = imessage && imessage.connected ? T.ok : (imessage && imessage.enabled ? T.warn : T.textTertiary);
      var imessageStatus = imessage && imessage.enabled
        ? (imessage.connected ? imT("connected") : imT("notConnected"))
        : imT("disabled");
      var imessageChildren = [
        React.createElement("div", { key: "t", style: imTitleStyle },
          Dot(imessageColor), "iMessage",
          React.createElement("span", { style: imMutedStyle }, imessageStatus)),
        React.createElement("div", { key: "hint", style: imMutedStyle }, imT("imessageHint")),
        React.createElement("div", { key: "btn", style: imRowStyle },
          React.createElement(P.Button, {
            variant: imessage && imessage.enabled ? "outline" : "primary", size: "sm", disabled: busy,
            onClick: function () { post(imessage && imessage.enabled ? "/im/imessage/stop" : "/im/imessage/start"); },
          }, imessage && imessage.enabled ? imT("imessageDisconnect") : imT("imessageConnect"))),
      ];
      if (imessage && imessage.error) imessageChildren.push(React.createElement("div", { key: "err", style: imErrStyle }, imessage.error));

      return React.createElement("div", null,
        React.createElement("div", { style: cardStyle }, teleChildren),
        React.createElement("div", { style: cardStyle }, wxChildren),
        React.createElement("div", { style: cardStyle }, imessageChildren));
    }
    ...
    function AboutPanel() {
      ...
      var rows = [
        { k: zh("Plugin", "插件"), v: "@kazecreator/dsh-im" },
    ...
    function SettingsProSection() {
      var tabState = React.useState("im-bridge");

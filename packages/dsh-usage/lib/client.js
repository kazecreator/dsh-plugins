window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var BUILTIN_TABS = [{ id: "usage", order: 0, zh: "用量", en: "Usage" }];
    ...
    function UsagePanel() {
      ...
      if (Array.isArray(balanceInfos) && balanceInfos.length > 0) {
        ...
        balChildren.push(Row({ key: "spent", label: zh("Estimated spent", "估算消费"), value: fmtMoney(data.lifetimeCost || 0, currency) }));
      ...
      var chartDays = (data.daily || []).map(function (o) {
        return {
          ...
          cacheWriteTokens: o.cacheWrite || 0,
      ...
      if (selected) {
        ...
        var write = selected.cacheWriteTokens;
        var totalInput = hit + miss + write;
    ...
    function AboutPanel() {
      ...
      var rows = [
        { k: zh("Plugin", "插件"), v: "@kazecreator/dsh-usage" },
